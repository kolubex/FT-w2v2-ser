...
CUDA_VISIBLE_DEVICES=$4 python run_pretrain.py --precision 16 --datadir $1 --labelpath $2 --labeling_method hard --saving_path $3 --training_step 10 --save_top_k 1 --wav2vecpath $7 &&
w2v_path=($3/w2v-*);
...
CUDA_VISIBLE_DEVICES=$4 python run_second.py --saving_path $3 --precision 16 --datadir $1 --labelpath $3/clusters/all-clus.json --training_step 8 --warmup_step 2 --save_top_k 1 --lr 1e-4 --batch_size 1 --num_clusters "64,512,4096" --use_bucket_sampler --dynamic_batch &&
